...
void MainWindow::on_volume_checkBox_clicked()
{

    if(ui->volume_checkBox->isChecked()){
        ...
        if(ui->mass_checkBox->isChecked()){

            ui->mass_checkBox->click();
        }

        if(ui->molar_concentration_checkBox->isChecked()){

            ui->molar_concentration_checkBox->click();
        }
    }

}

void MainWindow::on_molar_concentration_checkBox_clicked()
{
...
void MainWindow::on_mass_checkBox_clicked()
{
...
void MainWindow::calculate_volume(){
...
void MainWindow::calculate_molar_concentration(){
...
void MainWindow::calculate_mass(){
...
void MainWindow::calculate_normal_concentration(){

    QString error = CheckInput(
                ui->formula_input_for_parsing_LineEdit->text(),
                ui->normal_concentration_concentration_input_LineEdit->text(),
                ui->normal_concentration_volume_input_LineEdit->text()
                );
    ...
    if(error.isEmpty()){
        ...
        if(error.isEmpty()){
            ...
            const float concentration = ui->normal_concentration_concentration_input_LineEdit->text().replace(",",".").toFloat();
            const float volume = ui->normal_concentration_volume_input_LineEdit->text().replace(",",".").toFloat();
            const size_t equivalent = FindEquivalent(ui->formula_input_for_parsing_LineEdit->text());

            ui->molecular_weight_output_LineEdit->setText(QString::number(molecular_weigth));

            ui->normal_concentration_mass_output_LineEdit->setText(
...
void MainWindow::on_calculate_Button_clicked()
{
    ...
    if(ui->molar_solutions_groupBox->isVisible()) {
        ...
        } else if(ui->molar_concentration_checkBox->isChecked()) {

            calculate_molar_concentration();

        } else if(ui->mass_checkBox->isChecked()){
        ...
        calculate_normal_concentration();
...
void MainWindow::on_clear_Button_clicked()
{
    if(ui->molar_solutions_groupBox->isVisible()) {
        ...
        ui->normal_concentration_concentration_input_LineEdit->clear();
        ui->normal_concentration_volume_input_LineEdit->clear();
        ui->normal_concentration_mass_output_LineEdit->clear();
        ui->formula_input_for_parsing_LineEdit->clear();
        ui->molecular_weight_output_LineEdit->clear();
